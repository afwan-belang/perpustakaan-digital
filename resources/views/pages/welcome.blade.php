<x-app-layout>
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
            <h1 class="text-4xl font-bold text-white tracking-tight mb-2">Jelajahi Pustaka</h1>
            <p class="text-slate-400">Temukan wawasan baru dari koleksi buku digital kami.</p>
        </div>
